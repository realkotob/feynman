...
- Blockers: Need release CI observation and tracker closure/comments.
- Next: Confirm the follow-up release run publishes `0.2.41`, then close/comment issues #150, #151, #153 and PR #152.
